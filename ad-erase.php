...
$datosAnuncio = $anuncios->obtenerDatosAnuncio($_POST['delete']);
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="review-content-section">
                                            <div id="dropzone1" class="pro-ad addcoursepro">
                                                <h2 align="center">¿DESEA ELIMINAR ESTE ANUNCIO?</h2>
                                                <form action="page/eraseAd.php" class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload" method="post">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <select name="scope" id="scope" class="form-control" data-placeholder="Seleccione" disabled>
...
Ejemplo. (Bienvenidos. Estas viajando en un bus inteligente con SmartBas. Disfuta del viaje.)" disabled required><?php echo $datosAnuncio['contenido'];  ?></textarea>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <hr>
                                                            <div align="center">
                                                                <button type="submit" class="btn btn-danger" name="delete" <?php echo "value=\"".$datosAnuncio['id_anuncio']."\""; ?> >ELIMINAR ANUNCIO</button>
                                                                <a href="ad-active.php" class="btn btn-primary">CANCELAR</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
...
<script>
    if(responsiveVoice.voiceSupport()) {
        responsiveVoice.speak("¿desea borrar este anuncio?", "Spanish Female");
    }
    function testad(){
